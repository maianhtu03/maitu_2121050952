...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 26, 2023 lúc 03:30 AM
...
('1234567890', '123456', 'SV'),
('1234567891', '123456', 'SV'),
('1721050251', '123456', 'SV'),
('admin', 'admin', 'QT');
...
--
ALTER TABLE `tbl_diemhocphan`
  ADD CONSTRAINT `mhp_diemhocphan` FOREIGN KEY (`mhp`) REFERENCES `tbl_hocphan` (`mhp`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `msv_diemhocphan` FOREIGN KEY (`msv`) REFERENCES `tbl_sinhvien` (`msv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_lopchuyennghanh`
--
ALTER TABLE `tbl_lopchuyennghanh`
  ADD CONSTRAINT `mk_lopchuyennganh` FOREIGN KEY (`mk`) REFERENCES `tbl_khoa` (`mk`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_lophocphan`
--
ALTER TABLE `tbl_lophocphan`
  ADD CONSTRAINT `mhp_lophocphan` FOREIGN KEY (`mhp`) REFERENCES `tbl_hocphan` (`mhp`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mlcn_lophocphan` FOREIGN KEY (`mlcn`) REFERENCES `tbl_lopchuyennghanh` (`mlcn`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_sinhvien`
--
ALTER TABLE `tbl_sinhvien`
  ADD CONSTRAINT `mlcn_sinhvien` FOREIGN KEY (`mlcn`) REFERENCES `tbl_lopchuyennghanh` (`mlcn`);
COMMIT;
