...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 18, 2023 lúc 11:44 AM
...
INSERT INTO `tbl_lopchuyennganh` (`mlcn`, `tenlop`, `nienkhoa`, `siso`, `mk`) VALUES
...
INSERT INTO `tbl_sinhvien` (`msv`, `holot`, `ten`, `sodidong`, `email`, `mlcn`) VALUES
('1721050251', 'Hoàng Minh', 'Quang', '1636365887', '1721050251@student.humg.edu.vn', 'DCCTCT63'),
...
('2021050068', 'Hoàng Việt', 'Anh', '369873952', '2021050068@student.humg.edu.vn', 'DCCTDH65A'),
('2021050106', 'Nguyễn Hữu', 'Bằng', '335093712', '2021050106@student.humg.edu.vn', 'DCCTDH65A'),
...
('2021050173', 'Lê Văn', 'Đạt', '865421493', '2021050173@student.humg.edu.vn', 'DCCTDH65A'),
('2021050181', 'Nguyễn Tiến', 'Đạt', '367936202', '2021050181@student.humg.edu.vn', 'DCCTMM65A'),
('2021050194', 'Nguyễn Khắc', 'Đoàn', '395779703', '2021050194@student.humg.edu.vn', 'DCCTDH65A'),
('2021050203', 'Đỗ Quốc', 'Đức', '339622326', '2021050203@student.humg.edu.vn', 'DCCTDH65A'),
('2021050206', 'Ngô Văn', 'Đức', '355899098', '2021050206@student.humg.edu.vn', 'DCCTKT65A'),
('2021050221', 'Nguyễn Đức Trường', 'Giang', '917649254', '2021050221@student.humg.edu.vn', 'DCCTDH65A'),
...
('2021050418', 'Trần Tiến', 'Lực', '364946848', '2021050418@student.humg.edu.vn', 'DCCTDH65A'),
...
('2021050524', 'Nguyễn Ngọc', 'Phương', '969949564', '2021050524@student.humg.edu.vn', 'DCCTDH65A'),
...
('2021050558', 'Phạm Đức', 'Quyền', '563786722', '2021050558@student.humg.edu.vn', 'DCCTDH65A'),
('2021050573', 'Quàng Văn', 'Sơn', '795100115', '2021050573@student.humg.edu.vn', 'DCCTDH65A'),
('2021050608', 'Đặng Việt', 'Thắng', '353150766', '2021050608@student.humg.edu.vn', 'DCCTDH65A'),
('2021050633', 'Nguyễn Đức', 'Tiến', '969009287', '2021050633@student.humg.edu.vn', 'DCCTHT65A'),
('2021050691', 'Lê Anh', 'Tuấn', '367480136', '2021050691@student.humg.edu.vn', 'DCCTDH65A'),
('2021050708', 'Nguyễn Bá', 'Tùng', '359798885', '2021050708@student.humg.edu.vn', 'DCCTDH65A'),
...
('2021050874', 'Chu Đăng', 'Trường', '368739818', '2021050874@student.humg.edu.vn', 'DCCTDH65A'),
('2024011226', 'Lê Mậu', 'Toàn', '337514312', '2024011226@student.humg.edu.vn', 'DCCTKH65A'),
...
('2121051068', 'Nguyễn Đức ', 'Huy', '0374254312', '2121051068@student.humg.edu.vn', 'DCCTCT63'),
...
ALTER TABLE `tbl_diemhocphan`
  ...
  ADD CONSTRAINT `lopchuyennganh_diemhocphan` FOREIGN KEY (`msv`) REFERENCES `tbl_sinhvien` (`msv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_lopchuyennganh`
--
ALTER TABLE `tbl_lopchuyennganh`
...
ALTER TABLE `tbl_lophocphan`
  ...
  ADD CONSTRAINT `lopchuyennganh_lophocphan` FOREIGN KEY (`mlcn`) REFERENCES `tbl_lopchuyennganh` (`mlcn`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_sinhvien`
--
ALTER TABLE `tbl_sinhvien`
  ADD CONSTRAINT `lopchuyennganh_sinhvien` FOREIGN KEY (`mlcn`) REFERENCES `tbl_lopchuyennganh` (`mlcn`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
